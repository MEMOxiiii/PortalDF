...
// SetServerDraining is sent by the client to tell the proxy whether load balancers should stop routing new
...
func (*SetServerDraining) ID() uint16 { return IDSetServerDraining }
